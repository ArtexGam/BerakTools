...
##########################################################
#                   Muslim Cyber army			 #
#              Pancasila Cyber Team   		 #
#                   Laskar muslim Cyber Team			 #
##########################################################
cd modul
biru='\033[34;1m' #biru
...
do
clear
echo $tai "["$daun"!"$tai"]"$merah "© MR. ARTEX GAM"
sleep 2
sh logog.sh
...
echo $merah "+++[]============================[]+++"
sleep 0.2
echo $daun  "     1.FBBRUTE MR. ARTEX GAM"
echo $merah "+++[]============================[]+++"
sleep 0.2
...
clear
echo $tai
cowsay -f kiss.cow "MR. ARTEX GAM"
echo 	
echo			
echo	$cyyan "      Code By "$merah"MR. ARTEX GAM"
echo
echo
echo
echo $daun
...
then
clear
git clone https://github.com/umam97/Rebollution
mv berak $HOME
cd $HOME/Rebollution
python2 Berak.py
exit
...
then
clear
cowsay -f dragon.cow "Artex Gam" | lolcat
echo
echo
...
if [ $pilih = "26" ]
then
echo "Maaf Tools Masih Tahap Perbaikan"
sleep 4
...
echo $merah "[]=============================[]"
echo $merah "[]"$daun" Author    : MR. ARTEX_GAM "$merah"[]"
echo $merah "[]"$daun" Nama      : Umam       "$merah"[]"
echo $merah "[]"$daun" Panggilan : MR. ARTEX GAM   "$merah"[]"
echo $merah "[]"$daun" Umur      : 23 = Kepo      "$merah"[]"
echo $merah "[]"$daun" No Telp   : +1 715 6590888 "$merah"[]"
echo $merah "[]"$daun" Youtube   : Yt MR.ARTEX    "$merah"[]"
echo $merah "[]=============================[]"
echo
echo $merah "[]=============================[]"
...
echo $merah "[]"$daun" code       : Artex gam         "$merah"[]"
echo $merah "[]=============================[] "
echo
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo $merah "[]"$daun"               MyGrup              "$merah"[]"
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo $merah "[] "$tai"1.Muslim Cyber Army           "$merah"    []"
echo $merah "[] "$tai"2.Laskar Cyber Army [ Admin ]   "$merah"    []"
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo
echo
